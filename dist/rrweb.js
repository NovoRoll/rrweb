var rrweb = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    })(StyleSheetInteractions || (StyleSheetInteractions = {}));
        ...
        function patchingCSSStyleSheet() {
            ...
            CSSStyleSheet.prototype.insertRule = function (rule, index) {
                wrappedEmit(wrapEvent({
                    ...
                    data: {
                        source: exports.IncrementalSource.StyleSheetInteraction,
    ...
    var Replayer = (function () {
        ...
        Replayer.prototype.applyIncremental = function (e, isSync) {
            ...
            switch (d.source) {
                ...
                case exports.IncrementalSource.StyleSheetInteraction: {
                    var head = this.iframe.contentDocument.head;
                    var stylesEls = head.getElementsByTagName('style');
                    var styleSheet_1 = stylesEls[stylesEls.length - 1].sheet;
                    console.log("styleSheet", styleSheet_1);
                    if (styleSheet_1) {
                        setTimeout(function () { return styleSheet_1.insertRule(d.rule); }, 100);
                    }
                    break;
                }
                default:
